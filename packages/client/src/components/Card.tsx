...
export function CardView({ card, large }: { card: Card; large?: boolean }) {
  ...
  const w = large ? 'clamp(54px, 4vw + 0.4vh, 84px)' : 'clamp(40px, 2.6vw + 0.4vh, 62px)'
  const h = large ? 'clamp(76px, 5.6vw + 0.6vh, 118px)' : 'clamp(56px, 3.6vw + 0.6vh, 88px)'
  const rankSize = large ? 'clamp(20px, 1.9vw, 30px)' : 'clamp(16px, 1.4vw, 22px)'
  const suitCenter = large ? 'clamp(28px, 2.6vw, 42px)' : 'clamp(20px, 1.8vw, 30px)'
  return (
    <div style={{
      display: 'inline-flex',
...
export function CardBack() {
  const w = 'clamp(40px, 2.6vw + 0.4vh, 62px)'
  const h = 'clamp(56px, 3.6vw + 0.6vh, 88px)'
  return (
    <div style={{
      display: 'inline-flex',
      width: w,
