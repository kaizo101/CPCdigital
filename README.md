...
Das Projekt befindet sich in früher Entwicklung. Der aktuelle Release ist **v0.8.0** und bietet No-Limit Texas Hold'em und Pot-Limit Omaha High mit glaubwürdigen Bots, variant-spezifischer Handbewertung, formatisolierter Kalibrierung für Full Ring, 6-max und Heads-up, Auto-Rebuys und Hand-Replays. Weitere Varianten und die spätere Lernplattform sind in der [Roadmap](ROADMAP.md) beschrieben.
